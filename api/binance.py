...
class VirtualAPI(BinanceAPI):
    """
    API for trading virtually (for fake). Buy/sell orders posted to Binance API are replaced by fake posts.
    """
...
class TestAPI(BinanceAPI):
    """
    API for testing trade. Buy/sell orders posted to Binance API are posted to test endpoint.
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
